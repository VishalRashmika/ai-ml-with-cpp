...
float gradient_descent(float m_now,float b_now,float x[],float y[],float learning_rate){
    float m_gradient {0};
    float b_gradient {0};
    float m,b {0};
...
int main(){
    ...
    for (int i = 0; i <= epochs; i++){
        m, b = gradient_descent(m,b,area,targets,L);
    }

    std::cout << "THE END : M = " << m << " , B = " << b << std::endl;
